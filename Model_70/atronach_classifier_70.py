...
base_dir = 'dataset filepath' # include path to image files here
...
fnames = [os.path.join(train_storm_dir, fname) for fname in os.listdir(train_storm_dir)]

img_path = fnames[180]

img = image.load_img(img_path, target_size=(480, 854))
...
model.save('atronach_model_70.h5')
