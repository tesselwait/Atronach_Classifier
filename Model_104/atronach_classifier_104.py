...
fnames = [os.path.join(test_frost_dir, fname) for fname in os.listdir(test_frost_dir)]

img_path = fnames[39]
img = image.load_img(img_path, target_size=(240, 426))
...
model.add(layers.Conv2D(32, (3, 3), activation='relu', input_shape=(240, 426, 3)))
...
filepath="weights.best-104.hdf5"
...
model.save('atronach_model_104.hdf5')
