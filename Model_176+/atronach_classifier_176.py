...
base_dir = 'PATH' #path to image files
...
#model.add(layers.MaxPooling2D((2, 2))) # <- Model skips max pooling after 1st convolution layer
...
model.compile(loss='categorical_crossentropy',
              metrics=['acc'],
              optimizer='adam'#tfa.optimizers.Lookahead('adam')
              )
filepath="checkpoint\\weights.best-176.hdf5"
...
model.save('atronach_model_176.h5')
